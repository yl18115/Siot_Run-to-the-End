...
public class LeaderboardMenu : MonoBehaviour {
    ...
    [Space(10)] [Header("Leaderboard parameters")] [SerializeField]
    ...
    public void GetLeaderboard(string statisticName, bool friendsOnly, int startPosition) {
        ...
        FacebookAndPlayFabManager.Instance.GetLeaderboard(statisticName, friendsOnly, _maxResultsCount,
            GetLeaderboardCallback, startPosition);
    }
